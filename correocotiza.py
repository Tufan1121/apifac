...
def enviarEmailCot(destinatario, asunto, _usuario, _titulo, _documen, _fechayhora, _motivo, _importe, _descuento, _subtotal, _total, _empresa, _kind, _attachment :str = None):
    __kind=_kind
    ...
    if __name__ == "__main__":
        ...
        parser.add_argument('_link', type=str, help='Link de boton autoriza')
        ...
        enviarEmailCot(args.destinatario, args.asunto, args._usuario, args._titulo, args._documen, args._fechayhora, args._motivo, args._importe, args._descuento, args._subtotal, args._total, args._empresa, args._kind, args._attachment)
...
def enviarEmailSimple(destinatario, asunto, _usuario, _titulo, _attachment :str = None):
#    __kind=_kind
#    params = urlencode({"empresa": _empresa, "documento": _documen, "kind": __kind})
#    _link = "https://tufanvpn.dyndns-ip.com/api/auth.html?" + params
#    print(_link)
    ...
    if __name__ == "__main__":
        ...
        parser.add_argument('_attachment', type=int, help='Indica si lleva un adjunto')
        args = parser.parse_args()
        enviarEmailSimple(args.destinatario, args.asunto, args._usuario, args._titulo, args._attachment)
